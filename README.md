...
新規注文がリアルタイムに追加された状態や、Web Push通知が表示された場面も伝わるとよい。

<!-- スクリーンショット枠：注文一覧と新規注文通知
<p align="center">
